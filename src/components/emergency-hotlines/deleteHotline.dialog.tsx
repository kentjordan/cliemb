...
const DeleteHotlineDialog = ({ selectedItem, deleteDialogStateVisibility }: IDeleteDialogProps) => {
  ...
  return (
    <div className="flex flex-col rounded bg-white p-4">
      <div className="flex flex-col">
        ...
        <span className="my-3">Deleting a hotline is irreversible.</span>
        <span className="mt-1">
          Name:
        ...
        <button
          onClick={() => {
            const deleteUser = async () => {
              try {
                const res = await customAxios.delete(`emergency-hotlines/${selectedItem?.id}`, {
...
export default DeleteHotlineDialog;
